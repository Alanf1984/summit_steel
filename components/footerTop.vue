          ...
          ><v-row no-gutters>
            ...
            <v-col cols="12">
              <p class="mt-8 text-justify" style="max-width: 400px">
                Unlocking the Power of Steel: Summit Steel Fabricators Inc. -
                Your Trusted Partner for Superior Steel Fabrication Solutions in
              ...
              <v-list two-line class="transparent">
                <v-list-item>
                  ...
                  <v-list-item-content>
                    ...
                    <v-list-item-subtitle
                      >265 Caledonia Rd, Moncton, NB E1H 2E8,
                      Canadá</v-list-item-subtitle
                    >
                  </v-list-item-content>
                </v-list-item>
                <v-divider></v-divider>
                <v-list-item>
                  ...
                  <v-list-item-content>
                    ...
                    <v-list-item-subtitle
                      >info@summit-steel.com</v-list-item-subtitle
                    >
                  </v-list-item-content>
                </v-list-item>
                ...
                <v-list-item>
                  ...
                  <v-list-item-content>
                    ...
                    <v-list-item-subtitle>
                      +1 506-204-7981</v-list-item-subtitle
                    >
                  </v-list-item-content>
                </v-list-item>
                <v-divider></v-divider>
  ...
  data() {
    return {
      social: [
        {
          platform: 'Facebook',
          link: 'https://www.facebook.com/summitsteelnb',
          icon: 'mdi-facebook',
        },
        {
          platform: 'Instagram',
          link: 'https://www.instagram.com/summit_steel_fabricators',
          icon: 'mdi-instagram',
        },
        {
          platform: 'Linkedin',
